...
{
    public partial class frmReportNavigation : Form
    {
        ContextMenuStrip contextMenuStrip1 = new ContextMenuStrip();
        ContextMenuStrip roleContextMenuStrip = new ContextMenuStrip();
        public frmReportNavigation()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Report rpt = new Report { name = txtName.Text, RoleRequired = txtRole.Text, visualizationType = "DetailTwoColumn"};
            rpt.isPage = "true";
            ...
            ((Form1)Application.OpenForms["Form1"]).showMessage("Report Navigation Page was added successfully");
